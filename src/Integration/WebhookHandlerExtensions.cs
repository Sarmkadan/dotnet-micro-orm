...
public static class WebhookHandlerExtensions
{
    ...
    /// <exception cref="ArgumentNullException">Thrown if handler or payload is null</exception>
    /// <exception cref="ArgumentException">Thrown if signature is empty</exception>
        ...
        int retryDelayMs = 100)
    {
        ...
        return lastResult ?? new WebhookResult
        {
            Success = false,
    ...
    /// <exception cref="ArgumentNullException">Thrown if handler or payloads is null</exception>
    ...
    /// <exception cref="ArgumentNullException">Thrown if handler or eventType is null</exception>
    /// <exception cref="ArgumentException">Thrown if eventType is empty</exception>
    ...
    /// <exception cref="ArgumentNullException">Thrown if handler, payload, or expectedEventType is null</exception>
    /// <exception cref="ArgumentException">Thrown if expectedEventType is empty</exception>
    ...
    /// <exception cref="ArgumentNullException">Thrown if handler, payload, or requiredKeys is null</exception>
