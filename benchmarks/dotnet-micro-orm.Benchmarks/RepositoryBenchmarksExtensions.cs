...
namespace DotnetMicroOrm.Benchmarks
{
	...
	public static class RepositoryBenchmarksExtensions
	{
		...
		/// </summary>
		/// <param name="benchmarks">The benchmark instance. Cannot be <see langword="null"/>.</param>
		...
		/// </summary>
		/// <param name="benchmarks">The benchmark instance. Cannot be <see langword="null"/>.</param>
		/// <param name="iterations">How many times each warm‑up method should be executed. Must be greater than zero.</param>
		/// <exception cref="ArgumentNullException"><paramref name="benchmarks"/> is <see langword="null"/>.</exception>
		...
		/// </summary>
		/// <param name="benchmarks">The benchmark instance (required for the extension method syntax). Cannot be <see langword="null"/>.</param>
		/// <param name="operation">A delegate representing the operation to measure. Cannot be <see langword="null"/>.</param>
